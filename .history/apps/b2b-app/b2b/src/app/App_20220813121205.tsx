...
import { Button, Card, Checkbox, FormControlLabel, Modal } from '@myorg/ui-shared';
  ...
  return (
    <div>
      ...
      <Card
        ...
        />
        <br />
        <FormControlLabel control={<Checkbox checked={check} handleChange={handleChangeCheck} />} label="woho" />
        <br />
        <FormControl>
