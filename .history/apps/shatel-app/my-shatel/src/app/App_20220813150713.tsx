...
import { Button, Card, Input, Paper } from '@myorg/ui-shared';
    ...
    <div className='m-20'>
      ...
      <Modal 
       ...
       <Card
        ...
        <Input className="w-1/3 mx-auto my-8" label="input field" value={name} onChange={handleChange} type="text" className='w-full' placeholder='please insert some title'/>
    </div>
  );
}
