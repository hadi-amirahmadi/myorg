...
import { Button, Card, Input } from '@myorg/ui-shared';
    ...
    <div className='m-20'>
      ...
      <Modal 
       ...
       <Card
        ...
        />
        <br />
        <Input label='Outlined' value={name} onChange={handleChange} type="text" className='w-full' placeholder='please insert some title' variant='outlined'/>
    </div>
  );
}
