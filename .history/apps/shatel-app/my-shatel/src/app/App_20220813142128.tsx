  ...
  return (
    <div className='m-20'>
      ...
      <Modal 
       ...
       <Button color='primary' className='bg-amber-200 lowercase text-bl' variant='contained' startIcon={<Accessibility />} endIcon={<Accessible />}>button with start and end icon</Button>
