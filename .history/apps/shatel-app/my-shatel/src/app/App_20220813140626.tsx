  ...
  return (
    <div className='m-20'>
      ...
      <Modal 
       ...
       <Button color='primary' className='bg-amber-200' variant='contained' startIcon={<Accessibility />} endIcon={<Accessible />}>hi btn</Button>
       <div className='w-1/3 mx-auto my-16'>
        <Button color='primary' variant='contained'>hi btn</Button>
       </div>
       <div className='w-1.5 mx-auto my-16'>
        <Button color='warning' variant='outlined'>hi btn</Button>
       </div>
    </div>
  );
}
