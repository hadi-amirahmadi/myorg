  ...
  return (
    <div className='m-20'>
      ...
      <Modal 
       ...
       <Button color='primary' className='bg-amber-200' variant='contained' startIcon={<Accessibility />} endIcon={<Accessible />}>button with start and end icon</Button>
       ...
       <div className='w-80 mx-auto my-8'>
        <Button size='large' color='error' variant='contained'>large btn</Button>
       </div>
       <div className='w-80 mx-auto my-8'>
        <Button disabled color='error' variant='contained'>disabled btn</Button>
       </div>
    </div>
  );
}
