...
import { Button, Card, Input, Paper, Modal, Tooltip, Select, FormControlLabel, Radio, Checkbox, Switch } from '@myorg/ui-shared';
    ...
    <div className='m-20'>
      ...
      <Paper>
       ...
       <Select value={age} onChange={handleChangeSelect} label='nothing'>
        ...
        <FormControlLabel label='nobody' control={<Switch className='bg-amber-300' color='success' size='small' />} />
    </div>
  );
}
